...
namespace TestingUtils
{
    ...
    public class Plugin : BasePlugin
    {
        public override void Load()
        {
            ...
            var logSource = BepInEx.Logging.Logger.CreateLogSource("LogSource");
...
internal class ChatWindowPatch
{
    ...
    {   
        var logSource = BepInEx.Logging.Logger.CreateLogSource("LogSource");
        logSource.LogInfo("Input text: " + text.textString);
    ...
    static string give(string[] args)
    {
        ...
        logSource.LogInfo("Give command args: ");
        foreach (var arg in args)
        {
            logSource.LogInfo(arg);
        }
        ...
        {
            logSource.LogInfo("Invalid command");
    ...
    {
        var logSource = BepInEx.Logging.Logger.CreateLogSource("LogSource");
        logSource.LogInfo("Amount: " + amount);
